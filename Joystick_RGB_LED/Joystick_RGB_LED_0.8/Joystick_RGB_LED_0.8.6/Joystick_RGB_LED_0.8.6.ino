...
void loop() {
  ...
  y = y - MIDDLE;    //normal coordinate system
  ...
  RGB[0] = (1150 - distanceToRed - (1150 - 800)) / ((1150 - 800) / 255);       //(maxDistance - distance - (maxDistanceRed - radiusOfColorCircle)) / ((maxDistanceRed - radiusOfColorCircle) / 255)
  RGB[1] = (1208 - distanceToGreen - (1208 - 800)) / ((1208 - 800) / 255);
  RGB[2] = (1225 - distanceToBlue - (1225 - 800)) / ((1225 - 800) / 255);
  enforceMaxMin();
