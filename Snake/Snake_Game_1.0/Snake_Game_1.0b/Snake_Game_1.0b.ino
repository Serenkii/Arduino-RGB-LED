/*  Serenkii
    2021-03-05
    Working version, no defeat message though.
    Version b): The snake teleports to the other side when hitting the wall (border).

    Coming change: many bytes will be changed to chars because I just found out that byte is unsigned, char is the signed version of byte...
*/
